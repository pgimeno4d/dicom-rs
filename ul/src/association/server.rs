...
pub trait Negotiation {
    ...
    /// # }
    /// ```
    fn negotiate_roles(&self, _sop_class_uid: &str, _scu_role: bool, _scp_role: bool)
    -> Option<(bool, bool)> {
        None
    }
    ...
    fn process_a_association_rq(
        ...
        match msg {
            Pdu::AssociationRQ(AssociationRQ {
                ...
                // User variables resulting of negotiation are stored here
                ...
                for user_variable in user_variables {
                    ...
                    match user_variable {
                        ...
                        SopClassExtendedNegotiationSubItem(
                            ...
                            if let Some(negotiated_bytes) = self.negotiation.extended_negotiation(
                                &sop_class_uid,
                                &scai
                            ) {
                        ...
                        ScuScpRoleSelectionSubItem(
                            ...
                            if let Some((scu, scp)) = self.negotiation.negotiate_roles(
                                &sop_class_uid,
                                scu_role,
                                scp_role,
                            ) {
                ...
                new_user_variables.push(UserVariableItem::MaxLength(self.max_pdu_length));
